...
import { StyleSheet, View, Text, SafeAreaView, TextInput, ScrollView, TouchableOpacity, Alert, } from 'react-native';
   ...
   <View>
    ...
    <View style={styles.FiterToggle}>
     <View style={styles.FiterToggleSearch}>
      <TextInput placeholder='Search here ' placeholderTextColor="#BEC3D5" style={styles.Fiterinput} />
    ...
    <ScrollView style={styles.FiterScrollView} >
     {/* <!-- Table starts here --> */}
     {value === "Employee" && <View>
      <TouchableOpacity style={styles.FiterView} onPress={() => navigation.navigate('ReportStatus')}>
       <View style={styles.FiterNameUp}>
        <Text style={styles.FiterTextAlign}>
         <AntDesign style={styles.EmployeeIcon} name="idcard" size={10} />
        </Text>
       </View>
       <View style={styles.FiterNameContainer}>
        <View>
         <Text style={styles.FiterNameTop}>Chioma Gregg</Text>
         <Text style={styles.FiterNameBottom}>Employee verification (2hrs ago)</Text>
        </View>
        <View style={styles.FiterNameArrow}>
         <Text>
          <MaterialIcons style={styles.FiterArrowright} name="keyboard-arrow-right" size={25} />
         </Text>
        </View>
       </View>
      </TouchableOpacity>
     ...
     {value === "Guarantor" && <View>
      <View style={styles.FiterView}>
       <View style={styles.FiterNameUp2}>
        <Text style={styles.FiterTextAlign}>
         <FontAwesome5 style={styles.GuarantorIcon} name="people-arrows" size={12} />
        </Text>
       </View>
       <View style={styles.FiterNameContainer}>
        <View>
         <Text style={styles.FiterNameTop}>Bukola Adenike</Text>
         <Text style={styles.FiterNameBottom}>Guarantor verification (3days ago)</Text>
        </View>
        <View style={styles.FiterNameArrow}>
         <Text>
          <MaterialIcons style={styles.FiterArrowright} name="keyboard-arrow-right" size={25} />
     ...
     {value === "PWA" && <View>
      <View style={styles.FiterView}>
       <View style={styles.FiterNameUp3}>
        <Text style={styles.FiterTextAlign}>
         <Ionicons style={styles.PwaIcon} name="business" size={12} />
        </Text>
       </View>
       <View style={styles.FiterNameContainer}>
        <View>
         <Text style={styles.FiterNameTop}>Pascal Godwin</Text>
         <Text style={styles.FiterNameBottom}>PWA verification (2days ago)</Text>
        </View>
        <View style={styles.FiterNameArrow}>
         <Text>
          <MaterialIcons style={styles.FiterArrowright} name="keyboard-arrow-right" size={25} />
     ...
     {value === "Tenant" && <View>
      <View style={styles.FiterView}>
       <View style={styles.FiterNameUp4}>
        <Text style={styles.FiterTextAlign}>
         <Entypo style={styles.TenantIcon} name="location" size={12} />
        </Text>
       </View>
       <View style={styles.FiterNameContainer}>
        <View>
         <Text style={styles.FiterNameTop}>Kenneth Jennifer</Text>
         <Text style={styles.FiterNameBottom}>Tenant verification (2days ago)</Text>
        </View>
        <View style={styles.FiterNameArrow}>
         <Text>
          <MaterialIcons style={styles.FiterArrowright} name="keyboard-arrow-right" size={25} />
      ...
      <View style={styles.FiterView}>
       ...
       <View style={styles.FiterNameContainer}>
        <View>
         <Text style={styles.FiterNameTop}>Onyinyechukwu Joshua</Text>
         <Text style={styles.FiterNameBottom}>Tenant verification (2days ago)</Text>
        </View>
        <View style={styles.FiterNameArrow}>
         <Text>
        ...
        <View style={styles.modalTextInput}>
         <View style={styles.modalTextInputCOl}>
          <View style={styles.modalTextInputMargin}>
           <Text style={styles.modalInputColor}>Approved</Text></View>
          <View>
           <Text>
            <Checkbox
         ...
         <View style={styles.modalTextInputCOl}>
          <View><Text style={styles.modalInputColor}>Pending</Text></View>
          <View><Text>
           <Checkbox
            style={styles.checkbox}
            value={isChecked2}
         ...
         <View style={styles.modalTextInputCOl}>
          <View><Text style={styles.modalInputColor}>Disapproved</Text></View>
          <View>
           <Text>
            <Checkbox
             style={styles.checkbox}
